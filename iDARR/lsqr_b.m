...
% The i-th step gen-GKB iteration and update procedure
i = 1;
while  i<=k && alpha*beta >0  
  i= i+1;
  ...
  if i-1>k_lowbound && (isnan(beta) || beta <= tol_alpha_beta); i= i-1;  break; end
  ...
  if i-1>k_lowbound && (isnan(alpha)|| alpha<= tol_alpha_beta); i= i-1; break;  end
  ...
  if (i-1>k_lowbound) && (rho(i-1)< tol_res || eta(i-1)-eta(i-2)<tol_eta); break;  end
