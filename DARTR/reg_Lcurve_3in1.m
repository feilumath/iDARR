function [x_reg,lambda_opt,cLcurveAll] = reg_Lcurve_3in1(A,b,B,plotON, normType, phi)
...
for nn = 1:length(normType)
    ...
    switch norm_type
        case 'l2'     %% 1. Tikhonov regulariztion, norm_type = 'l2';
            ...
            cLcurveAll.creg_l2_loss_val    = norm(A*x_reg - b);
        ...
        case 'RKHS'   %% 3. Lcurve-rkhs regulariztion, norm_type = 'rkhs'
            ...
            cLcurveAll.creg_RKHS_loss_val    = norm(A*x_reg - b);
        % case 'H1'
        %     %%
        %     if ~exist('phi','var')
